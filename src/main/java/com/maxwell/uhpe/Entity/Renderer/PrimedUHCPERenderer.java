...
import com.maxwell.uhpe.Entity.BlockEntity.PrimedUHCPE;
...
public class PrimedUHCPERenderer extends EntityRenderer<PrimedUHCPE> {

    public PrimedUHCPERenderer(EntityRendererProvider.Context context) {
        super(context);
        this.shadowRadius = 0.0F;
    }

    public void render(PrimedUHCPE entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource source, int lightIn) {
        super.render(entity, entityYaw, partialTicks, poseStack, source, lightIn);
        float progress = (entity.getTime() + partialTicks) / PrimedUHCPE.MAX_TIME;
        ...
        BlockState state = ModBlock.UHCPE.get().defaultBlockState();
    ...
    public ResourceLocation getTextureLocation(PrimedUHCPE entity) {return TextureAtlas.LOCATION_BLOCKS;}
}